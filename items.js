...
const ItemDB = {
    ...
    spirit_array_small: {
        id: "spirit_array_small",
        name: "小型聚靈陣盤",
        type: "special",
        rarity: "purple",
        desc: "引動天地靈氣，立即獲得當前真氣上限 100% 的真氣。",
        lore: "由符修手作，能在短時間內極速匯聚周天靈氣。",
        autoConsume: true,
        autoUseOnGain: false,
        shop: {
            isShopItem: true,
        ...
        use(state) {
            ...
            const gain = cap;
            state.qi += gain;
            maybeLog(`你佈下小型聚靈陣，真氣完全恢復（${gain} 點）。`, "great-event");
            toast(`真氣完全恢復（${gain} 點）！`, "success");
        }
    },
